...
if (copyBtn) {
    copyBtn.addEventListener('click', function() {
        ...
        cards.forEach(card => {
            ...
            let reportText = "=== RELATÓRIO DE ANÁLISE - CADASTRO DE VEÍCULO DO CLIENTE ===\n";
            ...
            if (incBox) {
                ...
                grupos.forEach(grupo => {
                    ...
                    campos.forEach((titulo) => {
                        ...
                        // Motivo na mesma linha do campo, separado por espaço
                        ...
                        // Linha em branco entre cada motivo (sempre)
                        reportText += '\n\n';
                    });
                });
            } else {
